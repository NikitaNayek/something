...
{
  //write in you own, also download the game over picture and add a good sound if you wanna be safe.
  //Ache se krna complete. 
  //And yeah give a good bg music not like the music that causes headache
}
